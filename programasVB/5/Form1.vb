Public Class Form1
    ...
    End Sub
    Sub desplazamientos()
        txtiz1.Text = "={" & ceroini & "," & ceroini & "," & ceroini & "," & ceroini & "," & txtcol(1) & "},  //  "
        txtiz2.Text = "={" & ceroini & "," & ceroini & "," & ceroini & "," & txtcol(1) & "," & txtcol(2) & "},  //  "
        txtiz3.Text = "={" & ceroini & "," & ceroini & "," & txtcol(1) & "," & txtcol(2) & "," & txtcol(3) & "},  //  "
        txtiz4.Text = "={" & ceroini & "," & txtcol(1) & "," & txtcol(2) & "," & txtcol(3) & "," & txtcol(4) & "},  //  "

        txtde1.Text = "={" & txtcol(2) & "," & txtcol(3) & "," & txtcol(4) & "," & txtcol(5) & "," & ceroini & "},  //  "
        txtde2.Text = "={" & txtcol(3) & "," & txtcol(4) & "," & txtcol(5) & "," & ceroini & "," & ceroini & "},  //  "
        txtde3.Text = "={" & txtcol(4) & "," & txtcol(5) & "," & ceroini & "," & ceroini & "," & ceroini & "},  //  "
        txtde4.Text = "={" & txtcol(5) & "," & ceroini & "," & ceroini & "," & ceroini & "," & ceroini & "},  //  "
    ...
    Private Sub cliktxt(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtde1.Click, txtde2.Click, txtde3.Click, txtde4.Click, txtiz1.Click, txtiz2.Click, txtiz3.Click, txtiz4.Click, TextBox1.Click
