Public Class Form1
    ...
    Sub generacodigo()
        ...
        For jjj = 1 To 7
            For iii = 1 To 5
                valdatos = valdatos + 2 ^ (5 - iii) * datos(jjj, iii)
            Next
            txtcol(jjj) = changebase(valdatos)
            valdatos = 0
        Next

        TextBox1.Text = "{" & txtcol(1) & "," & txtcol(2) & "," & txtcol(3) & "," & txtcol(4) & "," & txtcol(5) & "," & txtcol(6) & "," & txtcol(7) & "},  //  "

        TextBox2.Text = "{" & txtcol(7) & "," & txtcol(6) & "," & txtcol(5) & "," & txtcol(4) & "," & txtcol(3) & "," & txtcol(2) & "," & txtcol(1) & "},  //  "
    ...
    Private Sub cliktxt(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.Click
